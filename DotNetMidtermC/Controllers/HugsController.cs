...
namespace DotNetMidtermC.Controllers
{
    ...
    public class HugsController : Controller
    {
        ...
        {
            ViewBag.HugTypeId = new SelectList(db.HugTypes.OrderBy(h => h.HugType1), "HugTypeId", "HugType1");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "HugId,Hugee,HugTypeId,HugDate")] Hug hug)
        {
            ...
            ViewBag.HugTypeId = new SelectList(db.HugTypes.OrderBy(h => h.HugType1), "HugTypeId", "HugType1", hug.HugTypeId);
            return View(hug);
        }
